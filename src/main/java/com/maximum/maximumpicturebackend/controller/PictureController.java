...
import com.maximum.maximumpicturebackend.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.maximum.maximumpicturebackend.api.imagesearch.ImageSearchApiFacade;
...
import com.maximum.maximumpicturebackend.common.DeleteRequest;
...
import com.maximum.maximumpicturebackend.manager.auth.StpKit;
import com.maximum.maximumpicturebackend.manager.auth.annotation.SaSpaceCheckPermission;
import com.maximum.maximumpicturebackend.manager.auth.model.SpaceUserPermissionConstant;
...
import com.maximum.maximumpicturebackend.model.enums.PictureReviewStatusEnum;
import com.maximum.maximumpicturebackend.model.vo.picture.PictureTagCategory;
...
//        String redisKey = "maximumpicture:listPictureVOByPage:" + hashKey;
//        //从Redis缓存中查询
...
//        }
        ...
        String queryCondition = JSONUtil.toJsonStr(pictureQueryRequest);
        String hashKey = DigestUtils.md5DigestAsHex(queryCondition.getBytes());
        String cacheKey = "maximumpicture:listPictureVOByPage:" + hashKey;
        //从本地缓存中查询
        String cachedValue = LOCAL_CACHE.getIfPresent(cacheKey);
        if(cachedValue != null){
            //如果缓存命中，返回结果
