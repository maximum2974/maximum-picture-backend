...
import com.maximum.maximumpicturebackend.mapper.UserMapper;
...
import static com.maximum.maximumpicturebackend.constant.UserConstant.USER_LOGIN_STATE;

/**
* @author maximum
* @description 针对表【user(用户)】的数据库操作Service实现
* @createDate 2025-02-04 20:53:43
*/
@Service
@Slf4j
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        // 4.记录用户登录态到 Sa-token，便于空间鉴权时使用，注意保证用户信息与 SpringSession 中的信息过期时间一致
